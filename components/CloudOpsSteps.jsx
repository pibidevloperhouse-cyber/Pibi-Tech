...
//  Evaluate infrastructure and workload readiness.
// 2 ) Architecture & Deployment Design
//  Secure, scalable infrastructure blueprints.
// 3 ) Optimization & Performance Management
//  Continuous workload tuning.
// 4 ) Security & Compliance Integration
//  Embedded governance and risk mitigation.
// 5 ) Monitoring & Lifecycle Support
//  Proactive observability and evolution planning.

const steps = [
  {
    title: "Cloud Readiness Assessment",
    description: "Evaluate infrastructure and workload readiness.",
  },
  {
    title: "Architecture & Deployment Design",
    description: "Secure, scalable infrastructure blueprints.",
  },
  {
    title: "Optimization & Performance Management",
    description: "Continuous workload tuning.",
  },
  {
    title: "Security & Compliance Integration",
    description: "Embedded governance and risk mitigation.",
  },
  {
    title: "Monitoring & Lifecycle Support",
    description: "Proactive observability and evolution planning.",
  },
];

export default function CloudOpsSteps() {
  return (
