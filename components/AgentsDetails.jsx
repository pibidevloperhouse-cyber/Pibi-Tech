...
const AgentsDetails = () => {
  ...
  const Card = ({ card }) => (
    <div
      ...
      className={`border-2 border-[#000052] min-h-150 p-8 flex flex-col justify-between group hover:shadow-lg transition-shadow cursor-pointer h-full ${card.variant === "blue" ? "bg-linear-to-r from-[#2563eb] to-[#059669] text-white transition-all" : "bg-white"}`}
    >
      <div>
